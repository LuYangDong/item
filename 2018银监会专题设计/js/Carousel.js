(function($) {
    var Carousel = function(poster) {
        ...
        this.nextBtn = poster.find(".lefts");
        this.prevBtn = poster.find(".rights");
        ...
        this.setting = {
            "width":1000,//幻灯片总宽
            "height": 400,//幻灯片总高
            "posterWidth": 260, //第一帧宽度 --> 当前显示
            "posterHeight": 370, //第一帧高度 --> 当前显示
            "scale": 0.8, //记录显示比例关系	
            "speed": 1000,
            "autoPlay": true,
            "delay": 2000,//自动播放间隔时间
    ...
    Carousel.prototype = {
        ...
        setPosterPos: function() {
            ...
            //间隙 = ((总宽 - 首张)/2)/右边张数
            gap = ((this.setting.width - this.setting.posterWidth) /2.5) / level;
            //除去第一张后左右的宽度
